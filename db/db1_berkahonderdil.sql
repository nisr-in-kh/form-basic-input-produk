...
INSERT INTO `admin` (`id_admin`, `nama_admin`, `pass_admin`, `created_at`) VALUES
(31, '', '', '2025-09-25 16:47:07');
...
INSERT INTO `sparepart` (`id_sparepart`, `id_mobil`, `nama`, `stock`, `grade`, `harga`, `deskripsi`) VALUES
(32, 0, 'Knalpot', 0, 'A', 100.00, 'Brumm...');
...
--
ALTER TABLE `sparepart`
  MODIFY `id_sparepart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
